...
const ProductInfo = ({ product, variant }) => {
    ...
    // console.log(variant['white'])


    // Add Item To the cart
    const addToCart = () => {
        dispatch({ type: 'addToCart', payload: { name: currentProduct.name, price: currentProduct.price, qty: 1, productId: currentProduct._id, size: currentProduct.size, variant: currentProduct.color } })
    }
                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex mb-4">
                                <span onClick={refreshVarient} className="flex items-center">
                                    <StarIcon />
                                    <StarIcon />
                                    <StarIcon />
                                    <StarIcon />
                            ...
                            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                                ...
                                <div className="flex ml-6 items-center">
                                    ...
                                    <div className="relative">
                                        <select onChange={(e) => refreshVarient(currentColor, e.target.value)} className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10">
...
export async function getServerSideProps(context) {
    ...
    let colorSizeInfo = {} // {red: {xl:{slug: wear-the-code-xl}}}
