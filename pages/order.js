                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            ...
                            <h1 className="text-secondary text-3xl title-font font-semibold ">Your Order ID #55568</h1>
                                    ...
                                    return (
                                        <>
                                            <div className="flex border-b border-gray-200 py-2">
                                                <span className="text-gray-500">{name.slice(0, 12)}...</span>
                            ...
                            <div className="flex flex-col">
                                <span className="title-font font-bold text-2xl text-secondary mt-5">${totalPrice}</span>
