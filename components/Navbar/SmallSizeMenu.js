            ...
            <div className={`${menuDropDown ? "" : "hidden"} bg-gray-100 w-full flex-grow lg:flex lg:items-center lg:w-auto block lg:hidden mt-2 lg:mt-0 z-20`} id="nav-content">
                <ul className="list-reset px-5 py-2">
                    ...
                    </Link>
                    {
                        userInfo.role === 'admin' &&
                        <Link href="/admin">
                            <li className={`${router.pathname == '/admin' ? 'bg-primary rounded-md text-white font-bold shadow-md' : 'shadow text-secondary'} mt-2 py-2 px-2 cursor-pointer flex items-center`}>
